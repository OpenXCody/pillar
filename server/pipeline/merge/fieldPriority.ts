...
const FIELD_PRIORITY: Record<FieldName, DataSource[]> = {
  name:          ['epa_echo', 'epa_tri', 'nhtsa', 'osha', 'usda_fsis', 'manual'],
  address:       ['epa_echo', 'epa_tri', 'nhtsa', 'osha', 'usda_fsis'],
  city:          ['epa_echo', 'epa_tri', 'nhtsa', 'osha', 'usda_fsis'],
  state:         ['epa_echo', 'epa_tri', 'nhtsa', 'osha', 'usda_fsis'],
  zip:           ['epa_echo', 'epa_tri', 'nhtsa', 'osha', 'usda_fsis'],
  county:        ['epa_echo', 'epa_tri', 'osha', 'usda_fsis'],
  latitude:      ['epa_echo', 'epa_tri', 'osha'],
  longitude:     ['epa_echo', 'epa_tri', 'osha'],
  companyName:   ['epa_tri', 'nhtsa', 'manual', 'epa_echo', 'osha'],
